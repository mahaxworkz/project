...
<div class="container">
        ...
        <h5 style="color: red">${anError}</h5>
 		...
 		<center>	<form class="form" action="updateRecords" method="post">
 			<div class="row">
		 		...
		 		<center><button type="submit" class="btn btn-primary" style="padding-left: 40px;padding-right: 40px;" >edit</button></center>
		 	</form>		</center>
