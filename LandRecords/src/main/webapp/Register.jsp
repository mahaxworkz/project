		...
		<div class="main-agileinfo">
			<div class="agileits-top">
				<form action="UserSave" method="post">
					...
					<input class="text" type="number" name="mobileNumber" placeholder="Mobile" required>
					<h5 style="color: red">${ismobilevalid}</h5>
					 <input class="text email" type="number" name="aadharNumber" placeholder="Aadhar" required>
					 <h5 style="color: red">${IsAadharValid}</h5>
 					<input class="text" type="password" name="password" placeholder="Password" required>
 					<h5 style="color: red">${IspassValid}</h5>
					<input class="text w3lpass" type="password" name="cPassword" placeholder="Confirm Password" required>
					
					<h5 style="color: red">${IscpassValid}</h5>
				...
				<p>Don't have an Account? <a href="userSignin.jsp"> Login Now!</a></p>
			</div>
		</div>
