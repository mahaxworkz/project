...
<body>
<!-- Navbar -->
<nav class="navbar navbar-expand-lg  " style="background-color:#3e4f4c;">
...
<div class="main-w3layouts wrapper">
			...
			<center>	 <h4 style="color: red;">${check}</h4></center>
			<center>	 <h4 style="color: green;">${saved}</h4></center>
				
				<center> <h4 style="color: red;">${findotp}</h4></center>
				<center> <h4 style="color: red;">${findotp2}</h4></center>
				<center> <h4 style="color: red;">${find}</h4></center>
				...
				<form action="otpcheck" method="post">
				 <input class="text email" type="hidden" name="email" value="${email01}"  placeholder="email"  
					  required>
