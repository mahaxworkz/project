...
<div class="container" style="text-align: center">
        ...
        <a class="btn btn-primary" href="read.jsp" role="button" style= "background-color: #2e2e2d; padding: 20px;  padding-left: 30px;">Add Records</a>
        
        <a class="btn btn-primary" href="search.jsp" role="button" style= "background-color: #2e2e2d; padding: 20px; padding-right: 30px; ">View Records</a>  
</div>
